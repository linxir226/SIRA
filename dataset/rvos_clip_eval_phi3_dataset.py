...
class RVOSEvalDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # extract keyframe according to the similarity between the expression and the frame
        ...
        condition_index = 0 # data['video_frame_path_list'].index(data['seg_frame_path'])   
