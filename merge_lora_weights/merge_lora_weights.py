...
def parse_args(args):
    ...
    parser.add_argument("--version", required=True, type=str, help="path to Chat-UniVi")
    parser.add_argument("--weight", required=True, type=str, help="path to the consolidated model state")
    parser.add_argument("--save_path", required=True, type=str, help="output directory")
    ...
    parser.add_argument(
        "--vision_tower",
        default="./checkpoints/clip-vit-large-patch14",
        type=str,
    )
